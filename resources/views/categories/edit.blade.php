...
<head>
    ...
    <title>Laravel Crud - Edit Category</title>
        ...
        <div class="mb-4 p-4 shadow sm:rounded-md sm:overflow-hidden">
            <form method="POST" action="/categories/{{ $category->id }}" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input name="category_title" value="{{ $category->category_title }}" class="block appearance-none placeholder-gray-500 border border-emerald-400 rounded-md w-full py-2 px-4 text-gray-700 leading-5 focus:outline-none focus:ring-2 focus:ring-emerald-200" type="text">
